...
<div class="form-group">
    {{ Form::label( "newsletter" , 'newsletter' , array( 'class'=>'col-lg-2 control-label' ) ) }}
    <div class="col-lg-10">
        {{ Form::select( "newsletter" ,array('0'=>'False','1'=>'True'), Input::old( "newsletter", $item->newsletter ) , array( 'class'=>'form-control' , 'placeholder'=>'Email' ) ) }}
    </div>
</div>
